...
export class ProjectsService {
    ...
    async createProject(params: { idProject: Project[`idProject`], title: Project[`title`]; description: Project[`description`], submission_date: Project[`submission_date`], period: Project[`period`], specification: Project[`specification`], area: Project[`area`], role: Project[`role`], auth: Project[`auth`], creator: Project[`creator`] }) {
